...
{
    /// <summary>
    /// CustomIntelliSense places red boxes behind all the "a"s in the editor window
    /// </summary>
    internal sealed class CustomIntelliSenseSQL
    {
        /// <summary>
        ...
        public CustomIntelliSenseSQL(IWpfTextView view)
        {
            if (view == null)
            {
